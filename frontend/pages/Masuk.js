  ...
  return (
    <View contentContainerStyle={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.masukIsi}>
          Menggunakan aplikasi ini dapat menimbulkan dampak positif kepada tubuh
        ...
        <View style={styles.email}>
          ...
          <View style={styles.emailBox}>
            <TextInput label="Email" placeholder="Email" textAlign="left" />
          </View>
        </View>
